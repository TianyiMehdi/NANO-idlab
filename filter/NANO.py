...
class NANO:
    ...
    # init_type: 'prior', 'laplace', 'iekf'
    # derivate_type: 'derivative', 'free'

    def __init__(self, model, loss_type='log_likelihood_loss', init_type='prior',
                 derivate_type='stein', iekf_max_iter=1, n_iterations=1, 
        ...
        self.iekf_max_iter = iekf_max_iter  # TODO: 可以改成实例传进来，Loss也可以写成实例
        self.delta = delta 
        self.c = c
        self.beta = beta
