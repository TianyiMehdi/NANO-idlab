...
from environ import RobotLinear
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="RobotLinear", type=str, help="Name of the model")
    ...
    for _ in tqdm(range(args_dict['N_exp'])):
        ...
        run_time = []
        model = RobotLinear(args_dict['state_outlier_flag'], args_dict['measurement_outlier_flag'],
