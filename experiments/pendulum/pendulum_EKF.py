...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="Pendulum", type=str, help="Name of the model")
    ...
    for _ in tqdm(range(args_dict['N_exp'])):
        ...
        run_time = []
        model = Pendulum(args_dict['state_outlier_flag'], args_dict['measurement_outlier_flag'], 
