...
if __name__ == "__main__":
    ...
    parser_filter.add_argument("--init_type", default='prior', type=str, help="Initialization type for Natural Gradient iteration, 'prior', 'laplace', 'iekf'")
    # Gaussian : 1, 1.0, iekf
    ...
    if filter_dict['init_type'] == 'iekf':
        parser_filter.add_argument("--iekf_max_iter", default=5, type=float, help="Iterations for iekf init")
